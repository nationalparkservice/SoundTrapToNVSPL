...
# PREREQUISITES: PAMGuide_Meta.R uses package "tuneR", which can be installed
...
PAMGuide_Meta <- function(fullfile,...,atype='TOL',plottype='Both',envi='Air',calib=0,ctype = 'TS',Si=-159,Mh=-36,G=0,vADC=1.414,r=50,N=Fs,winname='Hann',lcut=Fs/N,hcut=Fs/2,timestring="",outdir=dirname(fullfile),outwrite=0,disppar=1,welch="",chunksize="",linlog = "Log"){
